...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Bro", "Sto", "2019-03-01", "Joasia", "Nowakowska", "jkowalska@wp.pl", "jkowalska@wp.pl", "154dd", null)]
        [NUnit.Framework.TestCaseAttribute("Sel", "Bir", "2019-04-10", "Maciej", "Kowalski", "maciej@op.pl", "maciej@op.pl", "178_!", null)]
        [NUnit.Framework.TestCaseAttribute("Akr", "Tra", "2019-07-30", "Pawel", "Sobieski", "psobieski@o2.pl", "psobieski@o2.pl", "test", null)]
        public virtual void VerifyFlightsPageAndMakeSomeCustomSearch(string fromCity, string toCity, string date, string fname, string lname, string email, string emailc, string number, string[] exampleTags)
        {
...
#line 35
  testRunner.And(string.Format("I try enter coupon {0}", number), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 36
